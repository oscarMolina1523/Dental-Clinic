...
export class MedicalPrescriptionDetailRepository implements IMedicalPrescriptionDetailRepository {
  ...
  async findByMedicalPrescriptionId(medicalPrescriptionId: string): Promise<MedicalPrescriptionDetail[] | null> {
    ...
    const readCommand = builder.WithField("medicalPrescriptionId", medicalPrescriptionId).BuildReader();
